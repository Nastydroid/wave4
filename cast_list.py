...
#a list of actors' names. It will be run on the file flying_circus_cast.txt (this information
#was collected from imdb.com). Each line of that file consists of an actor's name,
